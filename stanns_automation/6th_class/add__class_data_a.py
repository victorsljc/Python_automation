...
def select_class():
    ...
    select_first_class = driver.find_element(By.XPATH,
                                             "//div[@class='nice-select primary_select form-control open']//li[@class='option'][normalize-space()='6 Class']")
...
wb = load_workbook("C:/Users/veera/Downloads/stanns_1_B_students_6_A.xlsx")  # Change to your file name
sheet = wb.active
...
def test_upload_student_bulk_data(admission_number,first_name,date,student_mail,parent_mail,date_of_birth):
    ...
    select_section('A') # selects A section
...
def test_add_data_to_portal():
    ...
    for i, row in enumerate(sheet.iter_rows(min_row=2, values_only=True), start=2):
            if i >38 :  # Stop after 47th data row (row 48 in Excel)
                break
