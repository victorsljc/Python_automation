...
def select_class():
    ...
    select_first_class = driver.find_element(By.XPATH,
                                             "//div[@class='nice-select primary_select form-control open']//li[@class='option'][normalize-space()='10 Class']")
...
wb = load_workbook('C:/Users/veera/Downloads/stanns_1_B_students_C.xlsx')  # Change to your file name
sheet = wb.active
...
def test_add_data_to_portal():
    ...
    for i, row in enumerate(sheet.iter_rows(min_row=2, values_only=True), start=2):
            if i >50 :  # Stop after 47th data row (row 48 in Excel)
                break
